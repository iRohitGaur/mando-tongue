...
btnTranslate.addEventListener("click", translateToMandoa)
var outputDiv = document.querySelector("#output-translated");

let serverURL = "https://api.funtranslations.com/translate/mandalorian.json"

document.addEventListener('DOMContentLoaded', function() {
    autosize(document.querySelector('#input-text'));
}, false);

function translateToMandoa() {
